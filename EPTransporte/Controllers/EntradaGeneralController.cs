...
namespace EPTransporte.Controllers
{
    public class EntradaGeneralController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            oEntrada = Clases.conexion.ObtenerEntradasGeneralesPendientes();
        ...
        {
            conexion.EliminarEntradaGeneral(id);
        ...
        public ActionResult VistaReporte(reporteFechas fecha)
        {
            ...
            else
            {
                ...
                List<DatosEntradaReporte> oEntrada = new List<DatosEntradaReporte>();
                oEntrada = conexion.ObtenerVistaReporteEntradaGeneral(fecha.FechaInicio.ToString("yyyy-MM-dd"), fecha.FechaFinal.ToString("yyyy-MM-dd"));
                ViewData["EntradaReporte"] = oEntrada;
        ...
        new DataColumn("Fecha de Entrada")
            ...
            DataTable myDT = conexion.ObtenerReporteExcelEntradaGeneral(lafecha1, fecha2);
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    return File(stream.ToArray(),
                        ...
                        $"Reporte_Trafico_Entradas_Generales_{DateTime.Now:yyyyMMddHHmmss}.xlsx");
                }
            }
        }
    }
